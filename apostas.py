...
@author: mihan
"""
from classecavalinho import Cavalinho
import pygame
import sys
...
while rodando:
  ...
  #cavalinhos correm
    ...
    if cavalinho1.rect.x < 1083:
        cavalinho1.correndo()
    
    if cavalinho2.rect.x < 1083:  
        cavalinho2.correndo()
    
    if cavalinho3.rect.x < 1083:
        cavalinho3.correndo()
    
    if cavalinho4.rect.x < 1083:
        cavalinho4.correndo()
    
    if cavalinho5.rect.x < 1083:
        cavalinho5.correndo()
    
    if cavalinho6.rect.x < 1083:
        cavalinho6.correndo()
